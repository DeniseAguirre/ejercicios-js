...
function triadaMenor(num1,num2,num3){
...
// 5. Realizar un programa que dado 2 objetos representando personas con las propiedades nombre, edad y altura imprima por pantalla cual de las 2 personas es la mas alta y cual es la de mayor edad.
    ...
    function mayorAlturaYEdad() {
        if(persona1.altura > persona2.altura) {
            console.log("La persona con mayor atura es " + persona1.nombre);
        }else if(persona2.altura > persona1.altura){
            console.log("La persona con mayor atura es " + persona2.nombre);
        }else{
            console.log("Ambos tienen el mismo alto");
        }

        if(persona1.edad > persona2.edad) {
            console.log("La persona con mayor edad es " + persona1.nombre);
        }else if(persona2.edad > persona1.edad){
            console.log("La persona con mayor edad es " + persona2.nombre);
        }else{
...
let altura = parseInt(prompt("Ingrese altura en cms: "));
let visión = parseInt(prompt("Ingrese visión en la escala de 1 a 10: "));

function puedeConducir(){
    if (edad >= 18 && visión >= 8 && altura >= 150) {
...
function adivinarNumero(numeroIncognita, intentos) {
  ...
  if (numeroIngresado === numeroIncognita) {
    ...
    if (intentos > 1) {
      adivinarNumero(numeroIncognita, intentos - 1);
    } else {
      alert(
...
adivinarNumero(numeroIncognita, intentos);
